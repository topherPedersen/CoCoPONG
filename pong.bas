...
566 IF P3>=30 THEN 580
567 SET(4, P1, 1): SET(4, P2, 1): SET(4, P3, 1)
568 P1=P1+6: P2=P2+6: P3=P3+6
569 SET(4, P1, 5): SET(4, P2, 5): SET(4, P3, 5)
570 GOTO 580

580 REM CREATE GAME AI (CONTROLS OPPONENTS PADDLE)
585 IF BY < C1 THEN 600
590 IF BY > C3 THEN 620
600 GOSUB 2000
610 GOTO 630
620 GOSUB 2100
